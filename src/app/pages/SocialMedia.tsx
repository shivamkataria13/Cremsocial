...
export default function SocialMediaPage() {
  ...
  const whatYouGet = [
    {
      ...
      description:
        "A clear plan built around your brand, your audience, and your goals.",
    },
    {
      title: "Content Creation",
      description:
        "Scroll-stopping posts, captions, and visuals created specifically for your brand.",
    },
    {
      title: "Posting & Scheduling",
      description:
        "Consistent posting across all your platforms so your audience always hears from you.",
    },
    {
      title: "Community Management",
      description:
        "We handle your comments and messages so your audience feels valued and heard.",
    },
    {
      title: "Monthly Reporting",
      description:
        "Simple performance reports every month so you can see exactly what is working.",
    },
  ];
  ...
  return (
    <>
      <Meta
        title="Social Media Management | Show Up. Stand Out. Stay Consistent."
        description="We manage your social media so your brand stays active, relevant, and engaging."
      />
      <div className="max-w-7xl mx-auto py-16 px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-800 leading-relaxed">
            Your audience is on social media every day. The question is, are
            they seeing you? At Crem Social, we manage your social media so your
            brand stays active, relevant, and engaging without you lifting a
            finger.
          </p>
        </motion.div>
        ...
        >
          <div className="rounded-3xl border border-indigo-200/60 bg-gradient-to-br from-white/80 via-indigo-50/40 to-violet-50/40 backdrop-blur-sm p-8 md:p-10">
            ...
            <p className="text-gray-700 mb-8">
              A reliable social media system that keeps your brand visible and
